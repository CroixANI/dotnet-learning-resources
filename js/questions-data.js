      ...
      questions: [
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Html Academy - Что на самом деле происходит, когда пользователь вбивает в браузер адрес google.com",
            ...
            {
              title:
                "Статья - VC - Что происходит, когда пользователь набирает в браузере адрес сайта",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - TProger - Основные принципы программирования: компилируемые и интерпретируемые языки",
      ...
      questions: [
        {
          ...
          links: [
            {
              title:
                "Статья - TProger - Git и GitHub: что это такое и в чём разница",
      ...
      questions: [
        {
          ...
          links: [
            {
              title:
                "Статья - TProger - Основные принципы программирования: стек и куча",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Хабр - Интересные моменты в C# (boxing unboxing)",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Metanit - Сборка мусора, управление памятью и указатели",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Dev Nuances - Разница между константами и полями только для чтения в C#",
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Видео - ExtremeCode - C# — Абстрактный класс vs Интерфейс",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Metanit - IEnumerable и IQueryable в Entity Framework",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - TProger - В чем разница между потоком и процессом?",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Хабр - Параллелизм против многопоточности против асинхронного программирования: разъяснение",
              url: "https://habr.com/ru/post/337528/",
            },
            {
              title:
                "Статья - В чем разница между асинхронным программированием и многопоточностью?",
            ...
            {
              title:
                "Видео - Диджитализируй! - Многопроцессность, многопоточность, асинхронность в Python и не только. Что это и как работает?",
          ...
          links: [
            {
              ...
              url: "ttps://metanit.com/sharp/tutorial/7.6.php",
            },
          ],
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Metanit - Интерфейсы и множественное наследование",
              url: "https://metanit.com/sharp/tutorial/3.48.php",
            },
          ],
        },
      ],
      ...
      questions: [
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Статья - DotNetTrick - Data Passing Techniques in ASP.NET Core",
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Статья - Хабр - Введение в REST API — RESTful веб-сервисы",
        ...
        {
          title:
            "Что такое HttpFilter, HttpHandler? Как они используются? Когда отрабатывают? Что им соответствует в ASP.NET Core?",
          links: [
            {
              title:
                "Статья - Microsoft Docs - HTTP-обработчики и модули HTTP (классический ASP.NET)",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Microsoft Docs - ПО промежуточного слоя (Middleware) в ASP.NET Core",
      ...
      questions: [
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Статья - Frontend Stuff - Поднятие или hoisting в JavaScript",
              url: "https://frontend-stuff.com/blog/hoisting/",
            },
            {
              title:
                "Статья - Medium - Разбираемся с “поднятием” (hoisting) в JavaScript",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - Хабр - Ключевое слово this в JavaScript для начинающих",
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Видео - IT-KAMASUTRA - prototype и __proto__ / JavaScript для собеседований",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Статья - TProger - Фундаментальные принципы объектно-ориентированного программирования на JavaScript",
              url: "https://tproger.ru/translations/oop-js-fundamentals/",
            },
            {
              title:
                "Статья - MDN - Вступление в Объектно-ориентированный JavaScript",
          ...
          links: [
            {
              ...
              url: "https://habr.com/ru/companies/sberbank/articles/672022/",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://habr.com/ru/companies/ruvds/articles/727474/",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://metanit.com/sql/sqlserver/12.1.php",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://habr.com/ru/articles/907600/",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://metanit.com/sql/tutorial/1.3.php",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://metanit.com/sharp/adonet/2.11.php",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              url: "https://metanit.com/sql/sqlite/5.2.php",
            },
          ],
        },
        {
      ...
      questions: [
        {
          ...
          links: [
            {
              title:
                "Статья - Medium - DI (inversion) vs DI(injection) vs IOC vs DI/IOC containers",
              url: "https://medium.com/@pkolmakov/di-inversoin-vs-di-injection-vs-ioc-vs-di-ioc-containers-83e925515ec",
            },
            {
              title:
                "Статья - Shwanoff - Инверсия управления и Внедрение зависимостей (IoС & DI)",
              url: "https://shwanoff.ru/ioc-and-di/",
            },
            {
              title:
                "Статья - Хабр - IoC, DI, IoC-контейнер — Просто о простом",
            ...
            {
              title:
                "Статья - Alex Kosarev - Инверсия управления: внедрение и поиск зависимостей",
        ...
        },
        {
          ...
          links: [
            {
              title:
                "Видео - DevShacht - Dependency Injection простыми словами (не C#)",
        ...
        },
        {
          ...
          links: [
            ...
            {
              title:
                "Статья - Sergey Teplyakov - Цикл статей о SOLID принципах",
        ...
        },
        {
          ...
          links: [
            {
              title: "Статья - Хабр - Что такое service mesh простыми словами",
              url: "https://habr.com/ru/companies/slurm/articles/705914/",
            },
          ],
        },
      ],
