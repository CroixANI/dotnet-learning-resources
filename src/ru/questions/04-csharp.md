...
* [Как и зачем использовать конструкцию using?](http://www.quizful.net/interview/csharp/using-keyword)
...
* [Видео — ExtremeCode — C# Абстрактный класс vs Интерфейс](https://www.youtube.com/watch?v=Y7V4bK0eHaA)
...
* [Статья — Metanit — IEnumerable и IQueryable в Entity Framework](https://metanit.com/sharp/entityframework/1.4.php)
